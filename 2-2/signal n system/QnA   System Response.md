...
### 12. Page 44, Q2: For the following circuit, find (i) Transfer function. (ii) Impulse response. (iii) Output $i_0(t)$ if $i_s(t) = e^{-2t}$. [Figure involved]
...
### **73. Page 62, Q(c): Obtain the convolution of the following pair of signals. *(Figure shows $f_1(t)$ as a ramp from (0,0) to (1,1) dropping to 0, and $f_2(t)$ as a rectangular pulse from t=1 to t=5 with amplitude 2).***
...
### **74. Page 63, Q(c) (Top): Obtain the Convolution of the pairs of signals in the figure below. *(Figure shows $x(t)$ as a rectangular pulse from t=0 to t=1 with amplitude 1, and $h(t)$ as a positive pulse from t=0 to t=1 with amp 1, followed by a negative pulse from t=1 to t=2 with amp -1).***
